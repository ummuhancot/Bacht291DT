...
/*        Baslangic degeri
        ...
        */
        ...
        //-------------do - while kisişe en az bir secenek sormak için kullanılır seçenek hayır demeden sürekli sunulur
        //bir kere gösterilsin mantığı vardır.
/*        Baslangic degeri
        do {
            calisacak kodlar
            Artirma/azaltma
        ...
        do {
            ...
            m++;
        } while (m < 1);// burda birkerer çalışır while kontrolünde m = 2 false üretir
        ...
        do {
            System.out.println("Ben do while loop um");
            m1++;
        } while (m1 > 1);//sonsuz döngüye girdi hiç çıkamayacağı bir döngüye soktumuzda virüs olmuş oluyor.
        // virüsler bu kodlar.
