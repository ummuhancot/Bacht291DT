...
public class Md01 {
    public static void main(String[] args) {
        ...
        int[][] a = new int[3][2];//3 dıştaki, 2 icteki eleman sayısı
        ...
        //coklu arreyler .deepToSring ile yazdırılır.

        //MultiDimensional Array’den spesifik bir eleman nasil yazdirilir?

        System.out.println(a[1][1]);//45 içinde tek bi eleman yazdırma
        ...
        String[][] students = {{"Ali", "Kemal"},{"Cemal"},{"Ayhan", "Beyhan", "Seyhan"},{"Ceyhan", "Burhan"}};//dıştaki için ed dış süslü parantez
