...
public class Md02 {
    public static void main(String[] args) {
        ...
        int totalNumberOfLement = 0;

        for (int [] w : numbers){
            totalNumberOfLement = totalNumberOfLement + w.length;
        }
        System.out.println(totalNumberOfLement);//5


        //--------------------------------
        //2.adim: Tek boyutlu Array’i, iki boyutlu Array’in eleman sayisini kullanarak olusturalim

        int [] newArr = new int[totalNumberOfLement];
        System.out.println(Arrays.toString(newArr));//[0, 0, 0, 0, 0]



        //---------------------------------burda 3 boyutlu arrey oluştur
