...
public class D4_PassByValuePassByReference {
    public static void main(String[] args) {

        /*Pass by Value (Değer ile Geçiş):  //JAVA DESTEKLER

        Bir değişkenin değerini, yani veriyi, bir metoda parametre olarak ilettiğinizde, aslında o değişkenin
        bir kopyasını iletirsiniz. Metodun içinde bu kopya değiştirilse bile, orjinal değişkenin değeri
        değişmez.
        Degisken ve Object'lerin adreslerinin (reference) kopyasinda calisilir.

        --> Primitiv lerde adreslerin kopyasında calışılır
        --> non-primitiv lerde refrence lerin kopyasında çalışılır*/
