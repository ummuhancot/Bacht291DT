...
public class Animal  {
    ...
    //public class Mammal extends Animal , ekleme yapılmaz{//perintı animal
    ...
    //final override yapılamaz değişiklik yapılamaz yani
    //final bir class ın child i olmaz
    //final bir method override edilemez
    //final bir verievıl yeni değer veya esayın yapılamaz

    //ÖDEV:Final overload a engel midir

    public void eat() {
        System.out.println("Animals eat . . .");//statik olmaz niye olmazdı unttum
    }

    //-----------------/////--------------
    public Animal create() {
        return new Animal();//Animal üretip dışarı Animal verdiniz demek
    }
    //----------------/////----------------
