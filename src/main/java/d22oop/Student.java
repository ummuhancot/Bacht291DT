...
public class Student {
        ////////veri saklama///////acces modifeysınlarla yapılır
    ...
    private int age = 13;//veri gizleme yaptık istediğime açıcam görebilir ve değiştirebilir olma
    private  boolean successful = true;

    //1- age ve successful datalarini okunabilir yapalim. Getter metodu okuma yaptigi icin parametre almaz


    public int getAge() {//privite ageyi dışarıya actı sadece okuma yapar
        return age;
    }
    ...
    public void setSuccessful(boolean successful) {//yukarda is olusşturdu set oluşturdu burdada
