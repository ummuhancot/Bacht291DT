...
public class AudiA4 implements EngineI1, AC2, Brake3 {

    //multiple inheritance olduğu için ihtiyac duyarız
    /*
    ...
    */
    ...
    @Override
    public void gas(){
        System.out.println("Audi A4 benzinli motor kullair");
    }

    //------------------------
    //AC interface’inden override edilenler
    //@Override etmesekte override eder
    public void analog(){
    ...
    public void abs() {
        System.out.println("Audi A4 ads fren sistemi kullanır");
    }
