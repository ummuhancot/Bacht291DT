...
public interface EngineI1 {
        ...
        //sözleşme kullanmak zorunludur ama bi tanesini alıp kullanmak yeterli
        ...
        //public static abstract yazmaya gerek yok
        void eco();
        void turbo();
        void gas();
        ...
        */
        ...
        static void speed(){
                System.out.println("Satte 300km hız yapar");
        }//overrid edilemez hesaplama amaçlı olabilir
