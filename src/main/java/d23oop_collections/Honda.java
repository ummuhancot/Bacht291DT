...
public abstract class Honda {//4.not abstract yaptı class ı
    ...
    */
    ...
    //-------------------23gün notları----özel durumlar
    //7) Final methodlar override edilemedigi icin, abstract olamazlar.
    // (***“final” bir access modifier değildir. “final,” bir Java anahtar kelimesidir)(KEYWORD)
    ...
    //-------------------
    public void music(){
        System.out.println("Pro müzik sistemi");
    }

    //4)Abstract method'lar ancak abstract class'lar icinde olusturulabilir.
    public abstract void engine();//engine motor demek //bady li bir method değil
