...
public class Queue01 {
    public static void main(String[] args) {
        ...
        Ilk giren ilk çıkar (FIFO-first in first out)(ilk giren ilk çıkar) prensibine dayanır,
        yani ilk eklenen obje ilk çıkarılır.
    ...
    Queue interface'i, LinkedList ve PriorityQueue gibi farklı class'lar tarafından uygulanabilir.*/
        ...
        Queue<String> storage = new LinkedList<>();//bir öğe birden fazla methoda sahip olabilir bu poliformizimdir
        ...
        //4)clear() metodu, kuyruğun içindeki tüm öğeleri kaldırır,
        // böylece kuyruk boş bir duruma gelir.

        storage.clear();
        System.out.println(storage);//[]

        //5)poll(): Kuyruğun başındaki öğeyi kuyruktan kaldırır ve döndürür.
        ...
        Eğer kuyrukta null elemanlar varsa, bu metodlar null döndüğünde kuyruğun gerçekten boş olup olmadığını ayırt etmek zorlaşır. bunu anlayamayiz. null elemaninimi kast ediyor bos mu demek istiyor.
        LinkedList sınıfı aslında null elemanları destekler,
        çünkü genel bir List yapısıdır ve null eleman eklenmesine izin verir.
        Ancak Queue arayüzü için kullanılmaya başladığında, mantıksal sorunlar ve kafa karışıklığı nedeniyle null eklemek önerilmez.
        Kısacası, Java'da Queue arayüzüne null eleman eklemek, mantıksal olarak sorunlara yol açabilir ve bu yüzden çoğu Queue implementasyonu bu işlemi desteklemez.
        */
        ...
        for (String w : d) {//alt alta yazdırması için yazdık
        ...
        arrayDeque.addFirst("İlk");
        arrayDeque.addLast("Son");
        System.out.println(arrayDeque);//[İlk, Son]

        //Eleman Çıkarma:
        //removeFirst(): Kuyruğun başından bir eleman çıkarır.
        //removeLast(): Kuyruğun sonundan bir eleman çıkarır.
        //--------arka planda array yapısını kullandığından arraydekler daha hızlı

        String a = arrayDeque.removeFirst();
        System.out.println(a);//İlk
        System.out.println(arrayDeque);//[Son]

        String z = arrayDeque.removeLast();
