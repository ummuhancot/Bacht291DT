...
public enum Cities {
    ...
    /*Java'da enum (enumeration - sıralama), bir dizi sabit değeri temsil etmek için kullanılan özel bir class türüdür.
      ...
      --yani değişme ihtimali olmayan şeyleri tutarız--sabitt değerler--
        ...
        Bu, geçersiz değerlerin atanmasını engeller.--geçersiz bir şey seçemezsiniz belirlenen değişmez kısmı seçersiniz
        --finaly bu enam yapısında çok geçer--
        ...
        Bu, kod tekrarını azaltır. Ve dis kaynaklara bagimliligi kaldirir.--özel bir class türüdür.
    ...
    //enamlar içinde main methot oluşturuluyor ama bir anlamı yoktur.
    //değiştirilemez olduğu için prayvıt yaptık dışardan değiştirilmeye izin vermicez sadece okumasına izin veririz.

    //---------------------enam yapısında dışardan erişim olmaz burdan erişmemiz lazım
    //public static void ADANA(1, "Adana", "01000"), yazamayız bile //posto kodu niye tırnakla girdi öncü 0 ı saklar
    ADANA(1, "Adana", "01000"),//posto kodu niye tırnakla girdi öncü 0 ı saklar
    ...
    private final int plateCode;//değişkenler
