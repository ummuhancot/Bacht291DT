...
public class E08 {
    public static void main(String[] args) throws IOException {//1-FileNotFoundException child exception 2-IOException parent exception
        ...
        4) throw belli sartlar icin Exception firlatmada kullanilir (age negatif olamaz diye biz sart koyduk)
           throws ise bir methodun belli bir Exception'u firlatabileceğini belirtmek icin kullanilir--yani ihtimal--
           (olusabilecek bir hataya karsi yazilir)
        */

        //-------------------------dosya okumada aski karekterlerin sayısal kısmı kullanılır
        ...
        /*int k = 0;//başlama olduguu için 0 yazdık
        int k;//null olsada okur
