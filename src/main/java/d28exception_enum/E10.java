...
public class E10 {
    public static void main(String[] args) {
        ...
        //finally
        //finally içine atılan kod hatalı olsun olmasın her şekilde çalışır
        ...
        //java da try + bir catch
        // try + birden fazla catch
        // try + catch + finally
        // try + finally kullanilabilir.--program durur--düzelmiyorsunuz acil bir işi hallediyorsunuz
    ...
    public static void bring(int[] c, int a, int b){
        ...
        try {
           ...
           int element = c[idx];//2
            ...
            System.out.println("datebase ile baglantiyi kesiniz");
        }
